        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">TEAM ERROR CHECKER</h6>
            ...
            <div class="widget-list row">
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        ...
                        <div class="widget-body">
                            <button type="button" id="sh_apr" onclick="Mudaestado('aprovadasapp');" class="btn btn-success">[LIVE] - [ <span id="aprovada_conta">0</span> ]</button>
                            ...
                            <button type="button" id="sh_rep" onclick="Mudaestado('reprovadasapp');" class="btn btn-danger">[DEAD] - [ <span id="reprovada_conta">0</span> ]</button>
                ...
                <div class="widget-holder widget-full-content widget-full-height col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title">PASTE THE CARDS.</h5>
                            <div class="widget-graph-info">
                                <div class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle text-muted fs-16" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#">Action</a>  <a class="dropdown-item" href="#">Another action</a>  <a class="dropdown-item" href="#">Something else here</a>
                                    </div>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <small>STATUS: <span class="bagde badge-pill badge-primary" id="demo">Ready to check</span> - 
                                    ...
                                    <p>BINS AND API'S METHOD :  <a target="_BLANK" href="https://t.me/OfficialTeamError">LISTS OF API'S</a></p>
